...
extra_files = [ ("",["README.txt"]),
              ...
              #images - man
              (os.path.join("data","images","man","blue"),
               glob.glob(os.path.join("data","images","man","blue","*.png"))),
               
              (os.path.join("data","images","man","red"),
               glob.glob(os.path.join("data","images","man","red","*.png"))),
               
              (os.path.join("data","images","man","green"),
              glob.glob(os.path.join("data","images","man","green","*.png"))),
               
              #images - spikes
              (os.path.join("data","images","spikes",),
               glob.glob(os.path.join("data","images","spikes","*.png"))),
               
              #images - hud
              (os.path.join("data","images","hud"),
               glob.glob(os.path.join("data","images","hud","*.png"))),
               ]
